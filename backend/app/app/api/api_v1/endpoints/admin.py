...
def create_voting(
    *,
    ...
    poll = schemas.PollCreate(id="a", date_creation=datetime.datetime.utcnow(), date_finish=datetime.datetime.utcnow(), topic="What programming languages do you use for Numerai?", options=[{"value":1,"text":"Python"}, {"value":2,"text":"R"}, {"value":3,"text":"Java"}, {"value":4,"text":"C/C++"}, {"value":5,"text":"Matlab"}, {"value":6,"text":"Julia"}, {"value":7,"text":"Others"}], is_multiple=True, owner_id=2)
