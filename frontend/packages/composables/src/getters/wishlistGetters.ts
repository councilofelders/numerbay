...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export const getWishlistItemImage = (product: any): string => product?.images[0] || 'https://numerai-public-images.s3.amazonaws.com/profile_images/weekend-Qzl7KmFRcrH6.jpg';
