...
const params: UseUserShippingFactoryParams<any, any> = {
  addAddress: async (context: Context, params?) => {
    Logger.debug('Mocked: addAddress', params.address);
  ...
  deleteAddress: async (context: Context, params?) => {
    Logger.debug('Mocked: deleteAddress', params);
  ...
  updateAddress: async (context: Context, params?) => {
    Logger.debug('Mocked: updateAddress', params);
  ...
  load: async (context: Context, params?) => {
    Logger.debug('Mocked: load');
    return Promise.resolve(shipping);
  },

  setDefaultAddress: async (context: Context, params?) => {
    Logger.debug('Mocked: setDefault');
