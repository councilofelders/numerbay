                ...
                <div class="form__radio-group">
                  <ValidationProvider v-slot="{ errors }" class="form__horizontal">
                    <SfRadio
                      ...
                      details="Voter IDs will be anonymized in the backend"
                    ...
                    <SfRadio
                      ...
                      value="false"
                      label="Named Votes"
                      details="Voter IDs will be stored in plain text"
                      v-model="form.isAnonymous"
                      class="form__radio"
                      :disabled="!!currentPoll"
                    />
                ...
                <div class="form__radio-group">
                  <ValidationProvider v-slot="{ errors }" class="form__horizontal">
                    <SfRadio
                      ...
                      details="Results are visible to voters before poll ends"
                ...
                <div class="form__radio-group">
                  <ValidationProvider v-slot="{ errors }" class="form__horizontal">
                    ...
                    <SfRadio
                      name="weightMode"
                      value="equal"
                      label="Equal Weights for All"
                      details="Equal weights, allows non-staked participants to vote"
                      v-model="form.weightMode"
                      class="form__radio"
                      :disabled="!!currentPoll"
                    />
...
<!--                <div class="form__radio-group">
                ...
                <div class="form__radio-group">
                  <ValidationProvider v-slot="{ errors }" class="form__horizontal">
                    <SfRadio
                      ...
                      details="Use NMR stake snapshot for weight calculation as of poll creation"
                    ...
                    <SfRadio
                      ...
                      details="Determine NMR stake for weight calculation after poll ends, only applicable to blind polls"
                      v-model="form.isStakePredetermined"
                      class="form__radio"
                ...
                <ValidationProvider rules="integer|min_value:0"  v-slot="{ errors }">
                  <SfInput
                    ...
                    :errorMessage="errors[0]"
                    name="minStake"
                    label="(Optional) Use Stake Snapshot as of Tournament Round"
                    type="number"
                    step=1
                    min=0
                    class="form__element"
