            ...
            <div class="tab-content mt-4" id="myTabContent">
                    ...
                    <div class="profile-setting-panel">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-6 mb-3">
                                <label for="username" class="form-label" :class="{ 'text-danger': Boolean(errors[0]) }">Username</label>
                                <input type="text" id="username" class="form-control form-control-s1" :class="!errors[0] ? '' : 'is-invalid'" v-model="form.username" required>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="email" id="email" class="form-control form-control-s1" :class="!errors[0] ? '' : 'is-invalid'" v-model="form.email">
                                <div class="text-danger fade" :class="{ 'show': Boolean(errors[0]) }">{{ errors[0] }}</div>
                            </div><!-- end col -->
                            </ValidationProvider>
                        </div><!-- end row -->
                        ...
                        <div class="row mt-4">
                          <div class="col-lg-8">
                            <a class="btn" :class="Boolean(userGetters.getPublicKey(user)) ? 'btn-outline-dark' : 'btn-dark'" @click="generateKeyPair">Generate key pair</a>
                            <button class="copy-text ms-2" type="button" v-if="Boolean(userGetters.getPublicKey(user))" @click="exportKeyPair"><em class="ni ni-download"></em> Export key file</button>
                          </div>
                        </div>
                        <hr class="my-4">
                          ...
                          <div class="col-lg-8">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="tooltip-s1">
                                    <button v-clipboard:copy="userGetters.getPublicAddress(user)" v-clipboard:success="onCopy" class="copy-text ms-2" type="button">
                        ...
                        <div class="row mt-4">
                          <div class="col-lg-8">
                            ...
                            }" class="btn btn-outline-dark"><em class="ni ni-plus"></em> Connect a new wallet</router-link>
                          </div>
                        </div>
                ...
                <div class="tab-pane fade" id="change-password" role="tabpanel" aria-labelledby="change-password-tab">
                    <div class="profile-setting-panel">
                        ...
                        <div class="mb-3">
                            <label for="newPassword" class="form-label" :class="{ 'text-danger': Boolean(errors[0]) }">New Password</label>
                            <div class="position-relative">
                                <input type="password" class="form-control form-control-s1" :class="!errors[0] ? '' : 'is-invalid'" id="newPassword" name="newPassword" placeholder="New password" v-model="pwdForm.password">
                                <a href="newPassword" class="password-toggle" :class="!errors[0] ? '' : 'text-danger'" title="Toggle show/hide pasword">
                        ...
                        <div class="mb-3">
                            <label for="confirmNewPassword" class="form-label" :class="{ 'text-danger': Boolean(errors[0]) }">Confirm New Password</label>
                            <div class="position-relative">
                                <input type="password" class="form-control form-control-s1" :class="!errors[0] ? '' : 'is-invalid'" id="confirmNewPassword" name="confirmPassword" placeholder="Confirm new password" v-model="pwdForm.confirmPassword">
                                <a href="confirmNewPassword" class="password-toggle" :class="!errors[0] ? '' : 'text-danger'" title="Toggle show/hide pasword">
                                    <em class="password-shown ni ni-eye-off"></em>
                                    <em class="password-hidden ni ni-eye"></em>
                                </a>
                            </div>
                        ...
                        <button class="btn btn-dark mt-3 d-flex justify-content-center" type="button" @click="handleSubmit(onUpdatePassword(reset))" :disabled="userLoading">
                          <span v-if="userLoading"><span class="spinner-border spinner-border-sm me-2" role="status" ></span>Saving...</span>
