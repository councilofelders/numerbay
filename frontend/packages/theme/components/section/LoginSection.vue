                    ...
                    <div class="col-lg-6">
                        ...
                        <form @submit.prevent="handleSubmit(handleLogin)">
                            ...
                            <div class="form-floating mb-4">
                                <input class="form-control" :class="!errors[0] ? '' : 'is-invalid border-danger'" id="username" placeholder="username" v-model="form.username">
                            ...
                            <div class="form-floating mb-4">
                                <input type="password" class="form-control password" :class="!errors[0] ? '' : 'is-invalid border-danger'" id="password" placeholder="Password" v-model="form.password">
                                <label for="password" :class="{ 'text-danger': Boolean(errors[0]) }">Password</label>
                                <a href="password" class="password-toggle" :class="!errors[0] ? '' : 'text-danger'" title="Toggle show/hide pasword">
