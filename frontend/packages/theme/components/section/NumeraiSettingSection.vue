<template>
  <div class="col-lg-9 ps-xl-5">
      ...
      <div class="profile-setting-panel-wrap">
        ...
        <div class="mb-3">
          <label for="numeraiApiKeyPublicId" class="form-label" :class="{ 'text-danger': Boolean(errors[0]) }">Numerai API Key Public Id</label>
          <input type="text" id="numeraiApiKeyPublicId" class="form-control form-control-s1" :class="!errors[0] ? '' : 'is-invalid'" v-model="form.numeraiApiKeyPublicId">
...
<!--        <div class="mb-3">
        ...
        <ValidationProvider rules="required|min:2" v-slot="{ errors }" slim>
        <div class="mb-3">
          <label for="numeraiApiKeySecret" class="form-label" :class="{ 'text-danger': Boolean(errors[0]) }">Numerai API Key Secret</label>
          <div class="position-relative">
            <input type="password" id="numeraiApiKeySecret" class="form-control form-control-s1" :class="!errors[0] ? '' : 'is-invalid'" v-model="form.numeraiApiKeySecret">
            <a href="numeraiApiKeySecret" class="password-toggle" :class="!errors[0] ? '' : 'text-danger'" title="Toggle show/hide pasword">
                <em class="password-shown ni ni-eye-off"></em>
                <em class="password-hidden ni ni-eye"></em>
            </a>
            <div class="text-danger fade" :class="{ 'show': Boolean(errors[0]) }">{{ errors[0] }}</div>
        ...
        <button class="btn btn-dark mt-3 d-flex justify-content-center" type="button" @click="handleSubmit(submitForm(reset))" :disabled="userLoading">
