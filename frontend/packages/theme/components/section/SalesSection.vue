        ...
        <div class="profile-setting-panel-wrap">
          <div class="table-responsive">
                <table class="table mb-0 table-s2">
                    ...
                    <tbody class="fs-13">
                        <tr v-if="!displayedOrders || displayedOrders.length === 0"><td colspan="3" class="text-secondary">You currently have no sale</td></tr>
                        <tr v-for="order in displayedOrders" :key="order.id">
                            <th scope="row"><a href="javascript:void(0);" @click="toggleModal(order)" title="Click for details">{{ orderGetters.getId(order) }}</a></th>
