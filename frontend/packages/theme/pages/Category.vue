                      ...
                      >
                        <template #label>
                          <nuxt-link
                            ...
                            :class="cat.isCurrent ? 'nuxt-link-exact-active nuxt-link-active sidebar--cat-selected' : ''"
                          >
                            All
                          </nuxt-link>
                        </template>
                      ...
                      >
                        <template #label="{ label }">
                          <nuxt-link
                            ...
                            :class="subCat.isCurrent ? 'nuxt-link-exact-active nuxt-link-active sidebar--cat-selected' : ''"
                          >
                            {{ label }}
                          </nuxt-link>
                        </template>
...
export default {
  ...
  setup(props, context) {
    ...
    const facets = computed(() => facetGetters.getGrouped(result.value, ['platform', 'rank', 'stake', 'return3m']));
